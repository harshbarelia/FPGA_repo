...
module tb_dma_bridge;
  ...
  initial begin
    ...
    s_tdata = 384'hDEAD; s_tkeep = {48{1'b1}}; s_tlast=1; s_tvalid=1; @(posedge clk); s_tvalid=0; repeat(2) @(posedge clk);
    ...
    for (int i=0;i<520;i++) begin
      s_tdata = i; s_tkeep = {48{1'b1}}; s_tlast=1; s_tvalid=1; @(posedge clk);
    end
    s_tvalid=0;
