...
VL_ATTR_COLD void Vtb_uart_rx___024root___eval_static__TOP(Vtb_uart_rx___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_uart_rx__DOT__clk = 0U;
}
...
VL_ATTR_COLD void Vtb_uart_rx___024root___dump_triggers__act(Vtb_uart_rx___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_uart_rx.clk or negedge tb_uart_rx.rst_n)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge tb_uart_rx.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_uart_rx___024root___dump_triggers__nba(Vtb_uart_rx___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_uart_rx.clk or negedge tb_uart_rx.rst_n)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge tb_uart_rx.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_uart_rx___024root___ctor_var_reset(Vtb_uart_rx___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_uart_rx__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__rx = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__rx_data = VL_RAND_RESET_I(8);
    vlSelf->tb_uart_rx__DOT__rx_valid = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__framing_error = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__send_byte__Vstatic__i = VL_RAND_RESET_I(32);
    vlSelf->tb_uart_rx__DOT__dut__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->tb_uart_rx__DOT__dut__DOT__cnt = VL_RAND_RESET_I(4);
    vlSelf->tb_uart_rx__DOT__dut__DOT__bit_idx = VL_RAND_RESET_I(3);
    vlSelf->tb_uart_rx__DOT__dut__DOT__shreg = VL_RAND_RESET_I(8);
    vlSelf->tb_uart_rx__DOT__dut__DOT__rx_s1 = VL_RAND_RESET_I(1);
    vlSelf->tb_uart_rx__DOT__dut__DOT__rx_s2 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb_uart_rx__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb_uart_rx__DOT__rst_n__0 = VL_RAND_RESET_I(1);
