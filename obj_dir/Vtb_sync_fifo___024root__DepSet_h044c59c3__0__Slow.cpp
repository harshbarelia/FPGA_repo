...
#endif
            VL_FATAL_MT("tb/tb_sync_fifo.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vtb_sync_fifo___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vtb_sync_fifo___024root___eval_stl(Vtb_sync_fifo___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vtb_sync_fifo___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD bool Vtb_sync_fifo___024root___eval_phase__stl(Vtb_sync_fifo___024root* vlSelf) {
    ...
    // Body
    Vtb_sync_fifo___024root___eval_triggers__stl(vlSelf);
...
VL_ATTR_COLD void Vtb_sync_fifo___024root___dump_triggers__act(Vtb_sync_fifo___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_sync_fifo.clk or negedge tb_sync_fifo.rst_n)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge tb_sync_fifo.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_sync_fifo___024root___dump_triggers__nba(Vtb_sync_fifo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_sync_fifo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_sync_fifo___024root___dump_triggers__nba\n"); );
    // Body
    if ((1U & (~ (IData)(vlSelf->__VnbaTriggered.any())))) {
        VL_DBG_MSGF("         No triggers active\n");
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_sync_fifo.clk or negedge tb_sync_fifo.rst_n)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge tb_sync_fifo.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_sync_fifo___024root___ctor_var_reset(Vtb_sync_fifo___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_sync_fifo__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__wr_en = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__rd_en = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__in_data = VL_RAND_RESET_I(8);
    vlSelf->tb_sync_fifo__DOT__out_data = VL_RAND_RESET_I(8);
    vlSelf->tb_sync_fifo__DOT__full = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__empty = VL_RAND_RESET_I(1);
    vlSelf->tb_sync_fifo__DOT__model_q.atDefault() = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb_sync_fifo__DOT__dut__DOT__mem[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->tb_sync_fifo__DOT__dut__DOT__wr_ptr = VL_RAND_RESET_I(5);
    vlSelf->tb_sync_fifo__DOT__dut__DOT__rd_ptr = VL_RAND_RESET_I(5);
    vlSelf->__Vtrigprevexpr___TOP__tb_sync_fifo__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb_sync_fifo__DOT__rst_n__0 = VL_RAND_RESET_I(1);
