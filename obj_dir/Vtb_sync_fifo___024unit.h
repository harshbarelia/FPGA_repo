...
class alignas(VL_CACHE_LINE_BYTES) Vtb_sync_fifo___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtb_sync_fifo___024unit(Vtb_sync_fifo__Syms* symsp, const char* v__name);
